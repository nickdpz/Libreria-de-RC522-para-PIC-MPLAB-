...
# 97 "mcc_generated_files/drivers/../eusart.h"
void EUSART_Initialize(void);
# 145 "mcc_generated_files/drivers/../eusart.h"
_Bool EUSART_is_tx_ready(void);
# 193 "mcc_generated_files/drivers/../eusart.h"
_Bool EUSART_is_rx_ready(void);
# 240 "mcc_generated_files/drivers/../eusart.h"
_Bool EUSART_is_tx_done(void);
# 260 "mcc_generated_files/drivers/../eusart.h"
uint8_t EUSART_Read(void);
# 280 "mcc_generated_files/drivers/../eusart.h"
...
typedef struct { uint8_t (*DataReady)(void); void (*Initialize)(void); uint8_t (*Read)(void); _Bool (*TransmitDone)(void); uint8_t (*TransmitReady)(void); void (*Write)(uint8_t txdata); } uart_functions_t;
...
const uart_functions_t uart[] = {
    {EUSART_is_rx_ready, EUSART_Initialize, EUSART_Read, EUSART_is_tx_done, EUSART_is_tx_ready, EUSART_Write }
};
